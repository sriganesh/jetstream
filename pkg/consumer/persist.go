...
func (c *Consumer) ReplayEvents(ctx context.Context, compressed bool, cursor int64, playbackRateLimit float64, emit func(context.Context, int64, string, string, string, func() []byte) error) (int64, error) {
	...
	for iter.First(); iter.Valid(); iter.Next() {
		...
		// Parse the event to extract the kind field
		kind := ""
